...
public class KitMasterCommandHandler implements TabCompleter{
	...
	@CommandHandler(cmd = "givekit", aliases = { "kit give" })
	...
	@CommandHandler(cmd = "kitlist", aliases = { "kit list" })
	...
	@CommandHandler(cmd = "kitinfo", aliases = { "kit info" })
	...
	@CommandHandler(cmd = "reloadkits", aliases = { "kit reload" })
	...
	@CommandHandler(cmd = "itemmeta savebook")
	...
	@CommandHandler(cmd = "itemmeta loadbook")
	...
	@CommandHandler(cmd = "itemmeta editbook")
	...
	@CommandHandler(cmd = "itemmeta savefirework")
	...
	@CommandHandler(cmd = "itemmeta loadfirework")
	...
	@CommandHandler(cmd = "itemmeta setname")
	...
	@CommandHandler(cmd = "itemmeta addlore")
	...
	@CommandHandler(cmd = "itemmeta removelore")
	...
	@CommandHandler(cmd = "itemmeta saveitem")
	...
	@CommandHandler(cmd = "itemmeta loaditem")
